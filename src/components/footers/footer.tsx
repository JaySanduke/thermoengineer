    ...
    return (
        <footer className="bg-neutral-100 dark:bg-neutral-600" >
            <div className="mx-auto text-center text-neutral-600 dark:text-neutral-200 lg:text-left">
                <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 ">
                    <div className="container flex justify-center lg:justify-between w-full">
                        ...
                        <div className="flex justify-center">
                            <a href="#!" className="mr-6 text-gray-600 dark:text-gray-200">
                                <svg
                ...
                <div className="mx-auto px-6 container py-10 text-center md:text-left">
                    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <p className="mb-4 flex items-center justify-center md:justify-start">
                                ...
                                4D, Fifth Floor, BCM City, <br/> Navlakha Square, A.B. Road, <br/> Indore, (M.P.) India 452001
                            </p>
                            <p className="mb-4 flex items-center justify-center md:justify-start">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <a href="mailto:thermoengindore@gmail.com">thermoengindore@gmail.com</a>
                            </p>
                            <p className="mb-4 flex items-center justify-center md:justify-start">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
