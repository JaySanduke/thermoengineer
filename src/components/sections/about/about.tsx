        ...
        <div className="relative flex flex-col-reverse md:flex-row">
          <div className="md:w-1/2">
            ...
            <a
              ...
              className="text-center text-md font-medium rounded-md shadow-md px-4 py-3 border-[1px] border-sky-500 text-sky-500 transition-colors duration-200 hover:bg-sky-500 hover:text-sky-700"
            >
              Learn More
            </a>
          </div>
          <div className="relative flex align-middle justify-center md:items-center lg:items-start mx-auto mb-6 max-w-sm md:max-w-full md:w-1/2 md:mb-0 p-6 px-6 lg:px-12">
